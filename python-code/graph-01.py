...
'''
    ...
    canvas.get_tk_widget().place(x = 400,y = 50,height = 800,width = 600)
    canvas.show()
'''
'''
...
def p1():
    ...
    # canvas = FigureCanvasTkAgg(figure1,root)
    # canvas.get_tk_widget().pack(anchor = E , expand=1)
    canvas.get_tk_widget().place(x = 500,y = xpos,height = 400,width = 300)
    canvas.draw()
'''
def p2():
...
# canvas = FigureCanvasTkAgg(figure1,root)
# canvas.get_tk_widget().pack(anchor = E , expand=1)
# canvas.get_tk_widget().place(x = 225,y = 500)
canvas = FigureCanvasTkAgg(figure1,root)
# canvas.get_tk_widget().pack(anchor = E , expand=1)
canvas.get_tk_widget().place(x = 400,y = 50,height = 800,width = 600)
canvas.draw()
