 ...
 * =====================================================================================
 *
 *       Filename:  clflush-z.c
 *
 *    Description:  
 *
 *        Version:  1.0
 *        Created:  2021年12月20日 11时50分15秒
 *       Revision:  none
 *       Compiler:  gcc
 *
 *         Author:  YOUR NAME (), 
...
#include <stdlib.h>
/*************************************************************************
    > File Name: ./clflush-z.c
    > Author: weihong
    > Mail:  
    > Created Time: 2021年12月20日 星期一 11时50分15秒
 ************************************************************************/
...
int main_0(int flush)
{
		...
		time2 = __rdtsc( ) - time1; /*  array[0] is a cache miss */
		printf( "miss latency = %lu \n", time2 );

		time1 = __rdtsc( ); /*  set timer */
		time3 = __rdtsc( ) - time1; /*  array[0] is a cache hit */
...
int main_1()
{
		...
		_mm_mfence();                      /*  this paroperly orders both clflush and rdtscp*/
		_mm_lfence();                      /*  mfence and lfence must be in this order + compiler barrier for rdtscp */
		time1 = __rdtsc();                 /*  set timer */
